...
pb <- readRDS(file.path(CONFIG$BULK_DIR, "xin_t2d_pseudobulk.rds"))
...
fwrite(metrics, file.path(CONFIG$OUT_DIR, "pb_xin_deseq2.csv"))
cat("Saved:", file.path(CONFIG$OUT_DIR, "pb_xin_deseq2.csv"), "\n")
